<template>
  ...
  <AuthenticatedLayout>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
      <h1 class="text-2xl">Próximas mensalidades à vencer</h1>
      <div class="w-full overflow-x-auto mt-4">
        <table class="w-full whitespace-no-wrap">
          <thead>
            <tr class="text-xs font-semibold tracking-wide text-left bg-white text-gray-500 
          ...
          <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            <tr v-for="mensalidade in mensalidades" class="text-gray-700 dark:text-gray-400">
              <td class="px-4 py-3">
                <div class="flex items-center text-sm">
                  <div>
                    <p class="font-semibold">{{ mensalidade.cliente.nome }}</p>
                  </div>
                </div>
              </td>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
      <h1 class="text-2xl">Projetos próximos da entrega</h1>
      <div class="w-full overflow-x-auto mt-4">
        <table class="w-full whitespace-no-wrap">
          <thead>
            <tr class="text-xs font-semibold tracking-wide text-left bg-white text-gray-500 
          ...
          <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            <tr v-for="projeto in projetos" class="text-gray-700 dark:text-gray-400">
              <td class="px-4 py-3">
                <div class="flex items-center text-sm">
                  <div>
